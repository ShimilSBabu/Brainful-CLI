...
## shell_tool
    {
        "name": "shell_tool",
        "description":"This tool can perform shell command execution if command, arguments(if any) and cwd(if applicable) are given. Note that the current system is windows. So, commands and arguments must be cmd friendly.",
